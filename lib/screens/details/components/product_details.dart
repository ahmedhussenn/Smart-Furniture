                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          if (productModel.incart == false) {
                            ...
                            final CollectionReference usersCollection = await FirebaseFirestore.instance.collection('Users').doc(uid).collection('cart');
                          //  final CollectionReference usersCollection = await FirebaseFirestore.instance.collection('cart');
                           ...
                           usersCollection.add(datatosave);
                            ...
                            Query<Map<String, dynamic>> query = productsRef.where('modelname', isEqualTo: productModel.name);
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          if (productModel.isFave == false) {
                            ...
                            final CollectionReference usersCollection = await FirebaseFirestore.instance.collection('Users').doc(uid).collection('favourite');
                            print(usersCollection.parent);
                            Map<String,dynamic> datatosave={
                           ...
                           // String uid = "7gkm6w6XfhnaC2tWUD4Q";
                            CollectionReference<Map<String, dynamic>> productsRef =
                                await FirebaseFirestore.instance.collection('Users').doc(uid).collection('favourite');
