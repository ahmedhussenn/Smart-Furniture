...
import 'package:untitled8/user_model.dart';
                          ...
                          children: [
                            ...
                            defaultTextFormField(hintText: 'User Name ',
                                ...
                                fieldValidator:(username){
                                  ...
                                  else if (  username.length!=null&&username.length<7){
                            ...
                            password.text.isEmpty? const SizedBox():const Align(
                                alignment: Alignment.centerLeft,
                                child: Text('Password Strength',style: TextStyle(color: Colors.white , fontSize: 15),)),
                            const SizedBox(height: 15,),
                            password.text.isEmpty? const SizedBox():LinearProgressIndicator(
                                  ...
                                  try {
                                    ...
                                    if (validForm) {
                                     ...
                                     // print("created new user");
                                      final user = UserModel( Name: userName.text.trim(), Email: email.text.trim(), Password: password.text.trim(), Phone: PhoneNumber.text.trim(),);
